...
data_1 = np.loadtxt('Programs/Power_k0.1_Brorby_part2')
...
plt.plot(data_1[:,0], data_1[:,2], label  =r"${\rm Brorby\ 2}$", c = 'r')
plt.plot(data_3[:,0], data_3[:,2], label  =r"${\rm constant }$", c = 'k')
...
plt.plot(data_2[:,0], data_2[:,2], label  =r"${\rm Brorby}$", c = 'r', ls='--')
plt.xlim(6,25)
